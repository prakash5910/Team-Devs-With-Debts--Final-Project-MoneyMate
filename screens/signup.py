...
class SignupScreen(Screen):
    # ids: name_input, username_input, email_input, password_input, error_label
    ...
    def do_signup(self):
        ...
        if success:
            ...
            App.get_running_app().current_user = {
                "id": result, "name": name, "username": username,
                "email": email, "currency": "USD", "theme": "light", "notifications": 1
            }
